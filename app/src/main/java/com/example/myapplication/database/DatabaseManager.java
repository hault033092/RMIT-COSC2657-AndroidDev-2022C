    ...
    public void populateData() {
        if (exists(DatabaseHelper.TABLE_COMPONENT)) {
            PcComponent[] components = {
                    ...
                    new PcComponent(3, "Intel CPU", R.drawable.intel_i9, "i9", "For Heavy Duty Uses", "CPU", 4, 530),
                    new PcComponent(4, "NVDIA VGA", R.drawable.graphic_card, "GeoForce RTX3060 rev 2.0 12Gb", "Max Gaming config", "VGA", 4, 429.44),
                    new PcComponent(4, "NVDIA VGA", R.drawable.graphic_card, "GeoForce GTX1650 Super Twin Fan", "Max Gaming config", "VGA", 4, 182.94),
                    new PcComponent(4, "NVDIA VGA", R.drawable.graphic_card, "Quardo RTX8000 48Gb", "Max Gaming config", "VGA", 4, 8899),
                    new PcComponent(5, "SamSung Storage Drive", R.drawable.storage_drive_ssd, "1Tb", "Fast responding", "Storage Drive", 4, 89.33),
                    new PcComponent(5, "SamSung Storage Drive", R.drawable.storage_drive_ssd, "1Tb", "Fast responding", "Storage Drive", 4, 51.44),
                    new PcComponent(5, "SamSung Storage Drive", R.drawable.storage_drive_ssd, "2Tb", "Fast responding", "Storage Drive", 4, 341.15),
                    new PcComponent(5, "SamSung Storage Drive", R.drawable.storage_drive_ssd, "250Gb", "Fast responding", "Storage Drive", 4, 51.09),
                    new PcComponent(6, "Sea Sonic", R.drawable.adapter, "1000W", "", "Power Supply", 4, 329.99),
                    new PcComponent(6, "Aigo AK", R.drawable.adapter_2, "600W", "", "Power Supply", 4, 699.99),
                    new PcComponent(6, "Front Tech Ps", R.drawable.adapter_3, "1000W", "", "Power Supply", 4, 142.8)
            };
